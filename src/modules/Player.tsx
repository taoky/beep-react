    ...
    <div className="p-6 bg-white rounded-md shadow-md space-y-4">
      <div>
        {playing ? (
          <button
            onClick={pause}
            className="w-32 px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600"
          >
            Pause
          </button>
        ) : (
          <button
            onClick={createPlay}
            className="w-32 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700"
          >
            Play
          </button>
        )}
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          onInput={(e) => setOscillatorType(e.currentTarget.value as OscillatorType)}
